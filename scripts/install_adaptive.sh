...
if [[ "$rosdist" == "i" ]]; then
    ...
    test_if_package_is_installed ros-indigo-pluginlib ros-indigo-transmission-interface ros-indigo-joint-state-controller ros-indigo-joint-trajectory-controller
else
    ...
    test_if_package_is_installed ros-kinetic-pluginlib ros-kinetic-transmission-interface ros-kinetic-joint-state-controller ros-kinetic-joint-trajectory-controller
fi
